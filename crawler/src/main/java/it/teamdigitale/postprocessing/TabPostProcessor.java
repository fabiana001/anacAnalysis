...
public class TabPostProcessor {
    ...
    public static void main(String[] args) throws IOException {
       ...
       String input = "notebooks/data/final_data/row_data/anacDataset_1525953489668.csv";

       // run(input,output);

        String output = "notebooks/data/final_data/row_data/anacDataset_1525953489668_postprocessed.tsv";
        ...
        try(BufferedReader br = new BufferedReader(new FileReader(input))) {
            ...
            for(String line; (line = br.readLine()) != null; ) {
                ...
                if(num_tokens == 17){
                    ...
                    System.out.println(count +" - " + num_tokens);
